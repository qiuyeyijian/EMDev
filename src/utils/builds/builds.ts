...
export class JenkinsBuildsApi {
  ...
  wait(path: string, buildNumber: number, options?: JenkinsBuildWaitOptions): Promise<JenkinsBuild> {
    return wait(this.requests, path, buildNumber, options)
  }

  waitForStart(path: string, buildNumber: number, options?: JenkinsBuildWaitOptions): Promise<JenkinsBuild> {
  ...
  abort(path: string, buildNumber: number, type: JenkinsBuildAbortType = JenkinsBuildAbortType.STOP): Promise<void> {
