...
export function isWorkflowMultiBranchProject(job: JenkinsJob): job is JenkinsJobWorkflowMultibranchProject {
...
export function isMultiConfigurationProject(job: JenkinsJob): job is JenkinsJobMultiConfigurationProject {
