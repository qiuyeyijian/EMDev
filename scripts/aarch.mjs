...
async function resolve() {
  ...
  const appPathList = [join("macos/Clash Verge.aarch64.app.tar.gz"), join("macos/Clash Verge.aarch64.app.tar.gz.sig")]
  ...
  await uploadAssets(release.id, [join(`dmg/Clash Verge_${version}_aarch64.dmg`), ...appPathList])
}
